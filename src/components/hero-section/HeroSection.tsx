...
const HeroSection = () => {
  ...
  return (
    <div className='px-20 py-20 flex items-center justify-between'>
      ...
      <div className='-mt-10'>
        <p
          className='text-[3rem] font-extrabold  leading-[4rem]
      ...
      {/* demo video */}
      <div className='relative select-none mt-10 -mr-10'>
        <Image
          src={'/demo-thumbnail.webp'}
          alt='hero-video'
          width={550}
          height={400}
          className=' bg-slate-100 rounded-md opacity-90 cursor-pointer peer transition-all duration-300 '
          style={{
            boxShadow: ' rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px',
          }}
          onClick={() => setIsPlayerOpen(true)}
        />
        <FaPlay className='scale-[3] absolute top-1/2 left-1/2 z-10  text-emerald-500/80 cursor-pointer transition-all duration-300 peer-hover:text-emerald-500/90 peer-hover:scale-[3.2]' />
      </div>
