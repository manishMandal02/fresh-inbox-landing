...
const Footer = () => {
  return (
    <div className='px-16 py-6 bg-slate-50 flex items-center justify-between border-t border-slate-200 w-full relative'>
      <ul className='flex items-center select-none'>
        <Image src={'/logo-128.png'} alt='logo' width={22} height={16} className='grayscale' />
        <span className='text-slate-600 ml-1 '>Fresh Inbox</span>
      </ul>
